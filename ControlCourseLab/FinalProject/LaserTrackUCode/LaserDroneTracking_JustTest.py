...
if __name__ == "__main__":
    ...
    while True:
        ...
        if mode == "laser":
            ...
            frame = cv2.circle(frame, (target[0], target[1]), proximity, (0, 255, 255), -1) #黃色是你目標座標(laser)
            frame = cv2.circle(frame, (center[0], center[1]), proximity, (255, 0, 0), -1) #紅色是你現在無人機座標

...
def DeterLaserArea(img, areaThreshold): 
    #【另外複製一張圖片.copy】
    imgContour = img.copy()   #複製img這張圖放到imgContour中
    img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY) #先弄成灰色比較好找邊
...
if __name__ == '__main__':
    ...
    h_min, h_max, s_min, s_max, v_min, v_max=136, 179, 14, 255, 255, 255
    ...
    try:
        while True:
            ...
            LaserCenter, img2Contour, img2Canny = DeterLaserArea(img2_filter, 0) #2000#areaThreshold

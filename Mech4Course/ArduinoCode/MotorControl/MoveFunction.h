double TurnFPer = 0.3;//0.4 230.0 / 150.0;  //150
double TurnBPer = 0.3;//0.4 1.0;          //150
// double TurnRPer = 230 / 200;  //想要右轉照比例條多快多慢//200
// double TurnLPer = 230 / 200;  //200
double TurnRPer = 0.3;//0.4 0.3  0.25; //0.2 //想要右轉照比例條多快多慢//200
double TurnLPer = 0.3;//0.4 0.3 0.25; //0.2 //200 <Debug> 200/200 除出來是interger!! 要200.0/200.0
double BigTurnRPer = 0.3; //0.2 //想要右轉照比例條多快多慢//200
double BigTurnLPer = 0.3;
